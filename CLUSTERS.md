...
# 2. Update catalog image in git
#    For pinned: edit components/operators/rhoai-operator/overlays/pinned/kustomization.yaml
#    For floating: edit components/operators/rhoai-operator/base/catalogsource.yaml

# 3. Commit and push
git add components/operators/rhoai-operator/
git commit -m "Upgrade RHOAI to X.Y"
git push
